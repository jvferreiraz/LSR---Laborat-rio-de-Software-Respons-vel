...
<nav class="modern-navbar" id="mainNavbar" aria-label="Navegação Principal">
    <div class="container nav-wrapper">
        <a href="<%=request.getContextPath()%>/index.jsp" class="brand" aria-label="FindGo - Ir para o início">
            <i class="fas fa-location-arrow" aria-hidden="true"></i> FindGo
        </a>

        <div class="nav-content">
            <ul class="nav-links">
                <li><a href="<%=request.getContextPath()%>/index.jsp">Início</a></li>
                <li><a href="<%=request.getContextPath()%>/itens.jsp">Itens</a></li>
                <li><a href="<%=request.getContextPath()%>/index.jsp#sobre">Sobre</a></li>
...
<section class="modern-hero" id="inicio">
    <div class="hero-content">
        <h1>Todos os <span>Itens Cadastrados</span></h1>
        <p>Gerencie seus itens perdidos e encontrados.</p>
        ...
        <button class="cta" onclick="document.getElementById('modalAnuncio').style.display='flex'">
            <i class="fas fa-plus"></i> Anunciar novo item
        </button>
    </div>
</section>
